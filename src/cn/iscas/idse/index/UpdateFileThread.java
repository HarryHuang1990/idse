...
public class UpdateFileThread{
	...
	public UpdateFileThread(WordSegmentation wordSegmentor, int docID, File file, String suffix){
							...
							if(!((StopWordFilter)InstanceManager.getInstance(InstanceManager.CLASS_STOPWORDFILTER)).isStopWord(word)){
								...
								if(isTitle){
									...
									if(this.postingTitles.containsKey(word)){
										...
										int postingID = UpdateFileThread.getPostingTitleID();
										...
										if(UpdateFileThread.dictionary.containsKey(word)){
											...
											UpdateFileThread.dictionary.put(word, term);
										}
									}
								}
								else{
									if(this.postingContents.containsKey(word)){
										...
										int postingID = UpdateFileThread.getPostingContentID();
