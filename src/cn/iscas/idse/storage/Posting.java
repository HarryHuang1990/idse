...
public class Posting {
	 ...
	 */
	@PrimaryKey(sequence="PostingID")
	private int postingID;
	
	@SecondaryKey(relate=MANY_TO_ONE, relatedEntity=Document.class, onRelatedEntityDelete=CASCADE)
	private int docID;
	
	@SecondaryKey(relate=MANY_TO_ONE, relatedEntity=InvertedIndex.class, onRelatedEntityDelete=CASCADE)
	private String term;
	/**
	...
	public Posting(int docID, String term){
		this.docID = docID;
		this.term = term;
	}
	
	public Posting(int docID, String term, Set<Integer> offsets){
		this.docID = docID;
		this.term = term;
